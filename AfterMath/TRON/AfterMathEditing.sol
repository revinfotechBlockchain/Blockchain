...
/**
	...
	contract AfterMath is ERC721Token, Ownable {
      /**Variables for uri use */
      string public uriString = "";
      string public Genesis = "https://file.globalupload.io/Ut8M8K3zdg.json";
      string public Mini = "https://file.globalupload.io/D0fay6t6z7.json";
      string public Oasis = "https://file.globalupload.io/jG1o5jzKx8.json";
      string public Refuge = "https://file.globalupload.io/t2LaHjBYyY.json";
	  ...
	  constructor() ERC721Token("AfterMath", "AIT") public {
	  ...
	  function buyToken(
		...
		require(msg.value >= currentPrice, "Amount of TRX sent too small");
    require(_typeID < 5,"Please enter type ID between 1 to 4");
