...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMathGenesis";
	...
	contract AftermathIslandsGenesis is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "1000";
        uint256 public currentSupply = 1000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/Genesis.json";
        string private About = "This is Genesis island asset";
		...
		function getDetails() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "Genesis";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Genesis.png";
			}
