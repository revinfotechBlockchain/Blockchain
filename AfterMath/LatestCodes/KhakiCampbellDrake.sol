...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMath KhakiCampbellDrake";
	...
	contract AftermathKhakiCampbellDrake is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/KhakiCampbellDrake.json";
        string private About = "Produces 1 cube manure per day. Requires 1 corn or feed per day. 1 hour breeding cool down.";
      ...
      //Get KhakiCampbellDrake Assets balance
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "KhakiCampbellDrake";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Khaki-Campbell-Drake.png";
			}
