...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMath BrahamaBull";
	...
	contract AftermathIslandsBrahamaBull is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/Brahama Bull.json";
        string private About = "Produces 3 cubes manure per day. Requires 6 corn or feed per 24 hours. 24 hour breeding cool down.";
      ...
      //Get BrahamaBull Assets balance
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "BrahamaBull";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Brahama-Bull.png";
			}
