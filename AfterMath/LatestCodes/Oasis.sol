...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMathOasis";
	...
	contract AftermathIslandsOasis is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "1500";
        uint256 public currentSupply = 1500;
	  ...
	  function buyToken(
		...
		uint256 index = allTokens.length + 1;
            ...
            uriString = "http://admin.playaftermath.com/assets/images/contract/Oasis.json";
            _title = "Oasis";
            _description = "This is Oasis island asset";
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "Oasis";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Oasis.png";
			}
