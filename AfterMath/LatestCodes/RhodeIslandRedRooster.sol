...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMath RhodeIslandRedRooster";
	...
	contract AftermathIslandsRhodeIslandRedRooster is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/RhodeIslandRedRooster.json";
        string private About = "Produces 1 cube manure per day. Requires 1 corn or feed per 24 hours. 1 hour breeding cool down.";
      ...
      //Get RhodeIslandRedRooster Assets balance
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "RhodeIslandRedRooster";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Rhode-Island-Red-Rooster.png";
			}
