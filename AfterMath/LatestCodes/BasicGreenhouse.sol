...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMathBasicGreenhouse";
	...
	contract AftermathIslandsBasicGreenhouse is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/BasicGreenhouse.json";
        string private About = "Uses 500 squares of space. Grows 500 squares of crops.10% crop growth production boost.";
      ...
      //Get BasicGreenhouse Assets balance
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "BasicGreenhouse";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Basic-Greenhouse.png";
			}
