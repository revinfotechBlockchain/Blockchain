...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMath BasicFreshWaterWell";
	...
	contract AftermathBasicFreshWaterWell is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/BasicFreshWaterWell.json";
        string private About = "Uses 50 squares of community or personal land space.Provides fresh water to 50,000 squares proximity.";
      ...
      //Get BasicFreshWaterWell Assets balance
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "BasicFreshWaterWell";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Basic-Fresh-Water-Well.png";
			}
