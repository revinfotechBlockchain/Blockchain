...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMath RhodeIslandRedHen";
	...
	contract AftermathRhodeIslandRedHen is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/RhodeIslandRedHen.json";
        string private About = "Produces 1 cube manure per day, 1 egg per day. Requires 1 corn or feed . 30 minute breeding cool down after egg is collected. Unlimited lifetime egg production.";
	  ...
	  function buyToken(
		...
		uint256 index = allTokens.length + 1;
            require(msg.value >= Price && Price > 0 , "Insufficient amount");
            uriString = contractURL;
            _title = "RhodeIslandRedHen";
            _description = About;
      ...
      //Get RhodeIslandRedHen Assets balance
        ...
        function getCurrentPrice() external view returns(
            ...
            _Price = Price;
				...
				function getDetails() external view returns(
					string memory _Name, 
					uint256 _Price, 
					uint256 _QuantatyLeft
					){
                            _Name = "RhodeIslandRedHen";
							_Price = Price;
							_QuantatyLeft = currentSupply;
				}
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_availables = currentSupply;
					_Name = "RhodeIslandRedHen";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Rhode-Island-Red-Hen.png";
			}
	    function sendTokenByOwner(uint _Quantity, address _toAddress) external onlyOwner returns(bool _status){
