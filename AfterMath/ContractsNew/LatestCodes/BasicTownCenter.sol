...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMath BasicTownCenter";
	...
	contract AftermathIslandsBasicTownCenter is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/Basic TownCenter.json";
        string private About = "Uses 2500 squares of community space. Community management and 10,000 cubes community storage.";
      ...
      //Get BasicTownCenter Assets balance
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "BasicTownCenter";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Basic-Town-Center.png";
			}
