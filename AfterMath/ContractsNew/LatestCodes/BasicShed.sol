...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMathBasicShed";
	...
	contract AftermathIslandsBasicShed is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/BasicShed.json";
        string private About = "Uses 250 squares of space. Stores 750 cubes. For storage.";
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "BasicShed";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Basic-Shed.png";
			}
