...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMathBasicBarn";
	...
	contract AftermathIslandsBasicBarn is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/BasicBarn.json";
        string private About = "Uses 500 squares of space. Houses 2 large animals or 6 small animals.Increases animal production by 10%.";
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "BasicBarn";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Basic-Barn.png";
			}
