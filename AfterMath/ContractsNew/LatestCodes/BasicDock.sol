...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMathBasicDock";
	...
	contract AftermathIslandsBasicDock is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/BasicDock.json";
        string private About = "Uses 200 squares community land space & over water space. Allows visitors and imports from other islands. Community building.";
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "BasicDock";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Basic-Dock.png";
			}
