...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMath NubianDoe";
	...
	contract AftermathIslandsNubianDoe is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/NubianDoe.json";
        string private About = "Produces 1 cube manure per day, ½ jar milk per day. Requires 2 corn or feed per day. 30 day breeding period. 15 day breeding cool down after kid birth. 500 lifetime births.";
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "NubianDoe";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Nubian-Doe.png";
			}
