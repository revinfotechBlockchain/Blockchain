...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMathMini";
	...
	contract AftermathIslandsMini is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "5000";
	  ...
	  function buyToken(
		...
		uint256 index = allTokens.length + 1;
            ...
            uriString = "http://admin.playaftermath.com/assets/images/contract/Mini.png";
            _title = "Mini";
            _description = "This is Mini island asset";
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "Mini";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Mini.png";
			}
