...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMath AngusBull";
	...
	contract AftermathIslandsAngusBull is ERC721Token, Ownable {
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "AngusBull";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Angus-Bull.png";
			}
