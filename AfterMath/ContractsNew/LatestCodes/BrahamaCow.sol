...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMath BrahamaCow";
	...
	contract AftermathIslandsBrahamaCow is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/BrahamaCow.json";
        string private About = " Produces 3 cubes manure per day, 1 jar milk per day. Requires 6 corn or feed per 24 hours. 60 day breeding period. 30 day cool down after calf birth. 500 lifetime births.";
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "BrahamaCow";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Brahama-Cow.png";
			}
