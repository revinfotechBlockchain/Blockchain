...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMathBasicHut";
	...
	contract AftermathIslandsBasicHut is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "100000";
        uint256 public currentSupply = 100000;
        uint256 public Price;
        string private uriString;
        string private contractURL = "http://admin.playaftermath.com/assets/images/contract/BasicHut.json";
        string private About = "Uses 250 squares of space. Stores 250 cubes. For avatar resting to restore health status, storage and personal property management.";
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "BasicHut";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Basic-Hut.png";
			}
