...
view
  ...
  */
	...
	contract ERC721Token is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721 {
	  ...
	  // Token name
	  string public constant name_ = "AfterMathRefuge";
	...
	contract AftermathIslandsRefuge is ERC721Token, Ownable {
      /**Variables for uri use */
		string  public maxSupply = "3500";
        uint256 public currentSupply = 3500;
	  ...
	  function buyToken(
		...
		uint256 index = allTokens.length + 1;
            ...
            uriString = "http://admin.playaftermath.com/assets/images/contract/Refuge.json";
            _title = "Refuge";
            _description = "This is Refuge island asset";
        ...
        function getCurrentPrice() external view returns(
			...
			function getAllDetails() view external returns(
				  uint256 _currentPrice,
					...
					_Name = "Refuge";
					_Image = "http://admin.playaftermath.com/assets/images/contract/Refuge.png";
			}
